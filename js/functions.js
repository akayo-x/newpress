...
$(document).ready(function () {
    // new StickySidebar('#sticky-rightbar', {
    //     topSpacing: 10,
    //     bottomSpacing: 50,
    // });

    // new StickySidebar('#sticky-content', {
    //     topSpacing: 10,
    //     bottomSpacing: 50,
    // });
});
...
/* ---------------------------------------------------------------------------------------------------------------------
 Слайдер листалки (нарративов)
 -------------------------------------------------------------------------------------------------------------------- */

$(function () {
    var slider = $('#js-narratives-slider');
    ...
    $('#js-narratives-slider-prev').click(function () {
        slider.trigger('prev.owl.carousel');
    });

    $('#js-narratives-slider-next').click(function () {
...
/* ---------------------------------------------------------------------------------------------------------------------
 Просмотр фото в статьях
 -------------------------------------------------------------------------------------------------------------------- */

$(document).ready(function () {
    Fancybox.bind(
        'a[data-toggle="lightbox"], img[class*="imagePattern"], img[class*="b-article__image"]',
        {
            groupAll: true,
            infinite: false,
            fullscreen: {
